                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register.custom') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="date_of_joining" type="date" class="form-control @error('date_of_joining') is-invalid @enderror" name="date_of_joining" value="{{ old('date_of_joining') }}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="manager" type="text" class="form-control @error('manager') is-invalid @enderror" name="manager" value="{{ old('manager') }}" required>
                            ...
                            <!-- Employee Picture -->
                            <div class="form-group row">
                                <label for="employee_picture" class="col-md-4 col-form-label text-md-right">{{ __('Employee Picture') }}</label>

                                <div class="col-md-6">
                                    <input id="employee_picture" type="file" class="form-control-file @error('employee_picture') is-invalid @enderror" name="employee_picture">
